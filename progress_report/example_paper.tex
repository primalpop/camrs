...
\icmltitlerunning{Submission and Formatting Instructions for ICML 2011}
...
\begin{abstract} 
ICML 2011 full paper submissions are due February 1, 2011. Reviewing will
...
Wide Web at:\\
\textbf{\texttt{http://www.icml2011.org/}}

\noindent
Send questions about these electronic templates to
\texttt{program@icml-2011.org}.
...
Submission to ICML 2011 will be entirely electronic, via a web site
(not email).  The URL and information about the submission process
are available on the conference web site at

\textbf{\texttt{http://www.icml-2011.org/}}

{\bf Paper Deadline:} The deadline for paper submission to ICML 2011
is Tuesday, February 1, 2011, at 11:59 p.m.~Samoa time.  If your full
...
Note that the 2011 style files use the {\tt hyperref} package to
make clickable links in documents.  If this causes problems for you,
add {\tt nohyperref} as one of the options to the {\tt icml2011}
...
$\mathit{28}^{th}$ International Conference on Machine Learning},
Bellevue, WA, USA, 2011.  Copyright 2011 by the author(s)/owner(s).''

For those using the \textbf{\LaTeX} style file, simply change
$\mathtt{\backslash usepackage\{icml2011\}}$ to 

\verb|\usepackage[accepted]{icml2011}|
...
2011 style file package.  In case that the original title exceeds the
...
you are using \LaTeX\/ and the \texttt{icml2011.sty} file, you may use
...
A sample file (in PDF) with author names is included in the ICML2011 style file package.
...
facility, use {\tt natbib.sty} and {\tt icml2011.bst} 
